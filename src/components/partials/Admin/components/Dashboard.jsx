...
import { AiOutlineUser, AiOutlineDollarCircle, AiOutlineCalendar, AiOutlineBarChart } from 'react-icons/ai'; // Importing icons
...
const Dashboard = () => {
  ...
  return (
    <div className="p-4">
      ...
      <Row gutter={16}>
        <Col span={6}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineUser className="inline-block text-lg mr-2" />Total Users</span>} 
              value={fakeUserCount}
        ...
        <Col span={6}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineDollarCircle className="inline-block text-lg mr-2" />Revenue Today</span>} 
              value={formatCurrency(fakeRevenue.day)} 
              valueStyle={{ fontSize: '2rem', color: '#3f8600', fontWeight: 'bold' }} // Enhanced styling for currency
            />
          </Card>
        </Col>
        <Col span={6}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineDollarCircle className="inline-block text-lg mr-2" />Revenue This Week</span>} 
              value={formatCurrency(fakeRevenue.week)} 
              valueStyle={{ fontSize: '2rem', color: '#3f8600', fontWeight: 'bold' }} // Consistent styling for all revenue numbers
            />
          </Card>
        </Col>
        <Col span={6}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineBarChart className="inline-block text-lg mr-2" />Total Subscriptions</span>} 
      ...
      <Row gutter={16} className="mt-4">
        <Col span={8}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineDollarCircle className="inline-block text-lg mr-2" />Revenue This Month</span>} 
              value={formatCurrency(fakeRevenue.month)} 
              valueStyle={{ fontSize: '2rem', color: '#3f8600', fontWeight: 'bold' }} 
            />
          </Card>
        </Col>
        <Col span={16}>
          <Card className="shadow-lg rounded-lg border border-gray-200" style={{ minHeight: '200px' }}>
            <Statistic 
              title={<span><AiOutlineCalendar className="inline-block text-lg mr-2" />Revenue in Date Range</span>} 
      ...
      <Row className="mt-8">
        <Col span={24}>
          <Card title="Revenue Over the Last 7 Days" className="shadow-lg rounded-lg border border-gray-200">
